                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Account Settings /</span> ${customer.username}</h4>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <!-- Account -->   
                                        <form enctype="multipart/form-data" action="changeimage?change=2&customerid=${customer.id}" method="post">
                                        <div class="card-body">
                                            <div class="d-flex align-items-start align-items-sm-center gap-4">
                                                <img
                                                    src="data:image/jpeg/png/jpg;base64,${customer.encodedImage}"
                                                    alt="user-avatar"
                                        ...
                                        <hr class="my-0" />
                                        <form method="POST" action="editcustomer?customerid=${customer.id}">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="mb-3 col-md-6">
                                                        ...
                                                        <input class="form-control" type="text" name="lastname" id="lastname" value="${customer.lastname}" placeholder="Last Name" />
                                                    </div>
                                                    <div class="mb-3 col-md-6">
                                                    ...
                                                    <div class="mb-3 col-md-6">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            ...
                                                            <input
                                                                ...
                                                                name="phonenumber"
                                                                class="form-control"
                                                                value="${customer.phone.replace("+", "").replace("84", "0")}"
                                                    ...
                                                    <div class="mb-3 col-md-6">
                                                        <label for="hireddate" class="form-label">Created Date</label>
                                                        <input class="form-control" id="hireddate" name="hireddate" placeholder="Hired Date" value="${customer.createdDate}"/>
                                                    </div>
                                                    <div class="mb-3 col-md-6">
                                                    ...
                                                    <div class="mb-3 col-md-6">
                                                        ...
                                                        <div class="input-group">
                                                            <label class="btn  col-4">
                                                                <input type="radio" name="status" value="Active" <c:if test="${customer.status == 'Active'}">checked </c:if>> Active
                                                                </label>
                                                               
                                                                <label class="btn col-4">
                                                                    <input type="radio" name="status" value="Suspended" <c:if test="${customer.status == 'Suspended'}">checked</c:if>> Suspended
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <div class="mt-2">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a class="btn btn-danger deactivate-account" onclick="deleteCustomer(${customer.id})">Deactivate Account</a>
