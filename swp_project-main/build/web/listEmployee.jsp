<%-- 
    ...
    Created on : May 22, 2023, 11:03:58 PM
    Author     : admin
--%>
                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span> List of Employees</h4>
                                    ...
                                    <div id="dynamic_content">
                                        <table class="table table-striped" >
                                            ...
                                            <tbody class="table-border-bottom-0" >
                                                <c:forEach items="${requestScope.employees}" var="e" varStatus="index">
                                                    <tr>
                                                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> ${index.index+1}</td>
                                                        <td>${e.firstname} ${e.lastname}</td>
                                                        <td>
                                                            <fmt:formatDate value = "${e.hiredDate}"  pattern="dd-MM-yyyy"/>    
                                                        </td>
                                                        <td>
                                                            ${e.role}
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <a href="editemployee?employeeid=${e.id}"
                                                                   ><i class="bx bx-edit-alt me-1"></i></a>
                                                                <a href="#" onclick="deleteEmployee(${e.id})"
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <span style=""><a href="<%=request.getContextPath()%>/stockexport?id=1" ><button class="customBtn col-2 btn btn-primary stick"><i class="fa fa-file-excel-o"></i> Export to Excel</button></a></span>
