<%-- 
    Document   : allManufacturer
    Created on : Jun 9, 2023, 3:46:30 AM
    Author     : admin
--%>
                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Stock /</span> All Manufacturer</h4>
                                    ...
                                    <div id="dynamic_content">
                                        <table class="table table-striped">
                                            ...
                                            <tbody id="table-data" class="table-border-bottom-0">
                                                <c:forEach items="${requestScope.manufacturers}" var="m" varStatus="index">
                                                    <tr>
                                                        <td>${index.index+1}</td>
                                                        <td>${m.manufacturerName}</td>
                                                        <td>${m.manufacturerAddress}</td>
                                                        <td>${m.manufacturerPhone}</td>
                                                        <td>${m.manufacturerEmail}</td>
                                                        <td>
                                                            <div class="dropdown">

                                                                <a href="editmanufacturer?manufacturerid=${m.manufacturerID}"
                                                                   ><i class="bx bx-edit-alt me-1 "></i></a>

                                                                <a href="#" onclick="deleteManufacturer(${m.manufacturerID})"
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <span style=""><a href="<%=request.getContextPath()%>/stockexport?id=4" ><button class="customBtn col-2 btn btn-primary stick"><i class="fa fa-file-excel-o"></i> Export to Excel</button></a></span>
