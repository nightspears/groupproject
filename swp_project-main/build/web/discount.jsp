                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Stock /</span> All Discount</h4>

                            <div class="card">
                                <h5 class="card-header">All Discount</h5>
                                    ...
                                    <table class="table table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Created Date</th>
                                                <th>Modified Date</th>
                                                <th>Created By</th><!-- comment -->
                                                <th>Modified By</th>
                                                <th>Action</th>
                                            </tr>
                                        </thead>
                                        <tbody id="table-data" class="table-border-bottom-0">
                                            <c:forEach items="${requestScope.listDiscount}" var="c" varStatus="index">
                                                <tr>
                                                    <td>${index.index+1}</td>
                                                    <td>${c.discountID}</td>
                                                    ...
                                                    <c:forEach items="${requestScope.listProduct}" var="p" >
                                                        <c:if test="${c.productID eq p.productID}">
                                                            <td>${p.productName}</td>
                                                        </c:if>
                                                    </c:forEach>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            <a href="#" data-bs-toggle="modal" data-bs-target="#basicModal${c.discountID}"
                                                               ><i class="bx bx-edit-alt me-1 "></i></a>

                                                            <a href="#" onclick="deleteDiscount(${c.discountID})"
                                                            ...
                                                            <script>
                                                                ...
                                                                function deleteDiscount(id)
                                                                {
                                                                    ...
                                                                    if (result)
                                                                    {
                                                                        window.location.href = "editdiscount?discountID=${c.discountID}";
                                                                    }
                                                                }
                                            ...
                                            <form action="editdiscount" method="post">
                                                <input type="hidden" name="discountID" value="${c.discountID}"/>
                                                <div class="modal fade" id="basicModal${c.discountID}" tabindex="-1" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel1">Edit Discount</h5>
                                                                <button
                                                                    type="button"
                                                                    class="btn-close"
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <div class="col mb-3">
                                                                        ...
                                                                        <input type="text" name="discountName" id="discountName${c.discountID}" class="form-control"  value="${c.discountName}"/>
                                                                    </div>
                                                                </div>
                                                                <div class="row g-2">
                                                                    <div class="col mb-3">
                                                                        <label for="discountValue" class="form-label">Discount Value (%)</label>
                                                                        <input type="text" name="discountValue" id="discountValue${c.discountID}" class="form-control"  value="${c.discountValue}"/>
                                                                    </div>
                                                                </div>
                                                                <div class="row g-2">
                                                                    <div class="col mb-3">
                                                                        <label for="startDate" class="form-label">Start Date</label>
                                                                        <input type="date" name="startDate" id="startDate${c.discountID}" class="form-control"  value="${c.startDate}"/>
                                                                    </div>
                                                                </div>
                                                                <div class="row g-2">
                                                                    <div class="col mb-3">
                                                                        <label for="endDate" class="form-label">End Date</label>
                                                                        <input type="date" name="endDate" id="endDate${c.discountID}" class="form-control"  value="${c.endDate}"/>
                                                                    </div>
                                                                </div>
                                                                <div class="row g-2">
                                                                    <div class="col mb-3">
                                                                        <label for="productID" class="form-label">Discount Product</label>
                                                                        <select class="form-control" id="productID${c.discountID}" name="productID">
                                                                            <c:forEach items="${requestScope.listProduct}" var="p">
                                                                                <option value="${p.productID}">${p.productName}</option>
                                                                                <c:if test="${c.productID eq p.productID}">
                                                                                    <script>
                                                                                        var dropdown = document.getElementById("productID${c.discountID}");
                                                                                        dropdown.selectedIndex = ${p.productID} - 1;
                                                                                    </script>
                                                                                </c:if>
                                                                            </c:forEach>
                                                                        </select>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                <label for="discountName" class="form-label">Discount Name</label>
                                                                <input type="text" name="discountName" id="discountName" class="form-control" placeholder="Enter Category Name" />
                                                            </div>
                                                        </div>
                                                        <div class="row g-2">
                                                            <div class="col mb-0">
                                                                <label for="discountValue" class="form-label">Discount Value (%)</label>
                                                                <input type="discountValue" name="discountValue" id="discountValue" class="form-control" placeholder="Enter description" />
                                                            </div>
                                                        </div>
                                                        <div class="row g-2">
                                                            <div class="col mb-3">
                                                                <label for="startDate" class="form-label">Start Date</label>
                                                                <input type="date" name="startDate" id="startDate" class="form-control"  value="${c.startDate}"/>
                                                            </div>
                                                        </div>
                                                        <div class="row g-2">
                                                            <div class="col mb-3">
                                                                <label for="endDate" class="form-label">End Date</label>
                                                                <input type="date" name="endDate" id="endDate" class="form-control"  value="${c.endDate}"/>
                                                            </div>
                                                        </div>
                                                        <div class="row g-2">
                                                            <div class="col mb-3">
                                                        ...
                                                        <div class="row g-2">
                                                            <div class="col mb-3">
                                                                <label style="color:#FF5050" for="productID" class="form-label">*Do you want to notify to all customer (This will take a moment) &nbsp;</label>
