                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                                ...
                                <div class="table-responsive text-nowrap">
                                    <table class="table table-striped">
                                        ...
                                        <tbody id="table-data" class="table-border-bottom-0">
                                            <c:set var="ping" value="${requestScope.ping}"/>
                                            <c:if test="${ping == null}">  
                                                <c:forEach items="${requestScope.listProduct}" var="c" varStatus="index">
                                                    <tr>
                                                        <td>${index.index+1}</td>
                                                        <td>${c.productID}</td>
                                                        <td>${c.productName}</td>
                                                        <td class="prices">${c.price}</td>
                                                        <td>${c.stockQuantity}</td>
                                                        <td>${c.productStatus}</td>
                                                        <td><fmt:formatDate value = "${c.expiryDate}"  pattern="dd-MM-yyyy"/></td>
                                                        ...
                                                        <td><a href="<%=request.getContextPath()%>/changeproduct?productID=${c.productID}"><i class="bx bx-edit-alt me-1 "></i></a></td>
                                                    </tr>
                                                </c:forEach>
                                            </c:if>
                                            <c:forEach items="${requestScope.listByCategory}" var="c" varStatus="index">
                                                <tr>
                                                    <td>${index.index+1}</td>
                                                    <td>${c.productID}</td>
                                                    <td>${c.productName}</td>
                                                    ...
                                                    <td><fmt:formatDate value = "${c.createdDate}"  pattern="dd-MM-yyyy"/></td>
                                                    <td><fmt:formatDate value = "${c.modifiedDate}"  pattern="dd-MM-yyyy"/></td>
                                                    <td><button class="button_change"><a href="<%=request.getContextPath()%>/changeproduct?productID=${c.productID}">Change</a></button></td>
                                                </tr>
                                            </c:forEach>  
                                        </tbody>
                                    </table>
                            ...
                            <span style=""><a href="<%=request.getContextPath()%>/stockexport" ><button class="customBtn col-2 btn btn-primary stick"><i class="fa fa-file-excel-o"></i> Export to Excel</button></a></span>
                        </div>   
