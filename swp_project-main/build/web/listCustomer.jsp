<%-- 
    ...
    Created on : Jun 9, 2023, 1:39:04 AM
    Author     : admin
--%>
                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span> List of Customers</h4>
                                    ...
                                    <div id="dynamic_content">
                                        <table class="table table-striped">
                                            ...
                                            <tbody class="table-border-bottom-0">
                                                <c:forEach items="${requestScope.customers}" var="c" varStatus="index">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <a href="editcustomer?customerid=${c.id}"
                                                                   ><i class="bx bx-edit-alt me-1"></i></a>
                                                                <a href="#" onclick="deleteCustomer(${c.id})"
