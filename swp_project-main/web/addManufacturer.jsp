<%-- 
    ...
    Created on : Jun 9, 2023, 4:14:53 AM
    Author     : admin
--%>
                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Add New Manufacturer</span> </h4>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <!-- Account -->          
                                        <form enctype="multipart/form-data" action="addmanufacturer" method="POST" >
                                            <div class="card-body">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="mb-3 col-md-6">
                                                        ...
                                                        <input class="form-control" type="text" name="address" id="address"  placeholder="Manufacturer Address" />
                                                    </div>
                                                    <div class="mb-3 col-md-6">
