                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> Add News</h4>

                            <div class="card">
                                <h5 class="card-header">News</h5>
                                <form id="newsForm" method="post" enctype="multipart/form-data" action="addnews">
                                    <div class="container">
                                        <input type="hidden" value="${s.newsID}" id="newsID" name="newsID">
                                        <div class="input-margin form-group row">
                                            <div class="col-md-3 col-lg-3">
                                                <label for="newsTitle">News Title:</label>
                                            </div>
                                            <div class="col-md-9 col-lg-9">
                                                <input type="text" class="form-control" value="${s.newsTitle}" id="newsTitle" name="newsTitle" required>
                                            </div>
                                        </div>
                                        <div class="input-margin form-group row">
                                            <div class="col-md-3 col-lg-3">
                                            ...
                                            <div class="col-md-9 col-lg-9">
                                                <input type="text" class="form-control" value="${s.newsHeading}" id="newsHeading" name="newsHeading" required>
                                            </div>
                                        ...
                                        <div class="input-margin form-group row">
                                            ...
                                            <div class="col-md-9 col-lg-9">
                                                <textarea class="form-control"  name="newsContent" rows="3" id="editor" value="">${s.newsContent}</textarea>
                                            </div>
                                        </div>
                                        <div class="input-margin form-group row">
                                            <div class="col-md-3 col-lg-3">
