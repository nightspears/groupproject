<%-- 
    Document   : ManufacturerDetail
    Created on : Jun 9, 2023, 5:11:33 AM
    Author     : admin
--%>
                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">View Manufacturer</span> </h4>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card mb-4">
                                        <h5 class="card-header">Manufacturer Details</h5>
                                        <!-- Account -->          
                                        <form enctype="multipart/form-data" action="changeimage?change=3&manufacturerid=${manufacturer.manufacturerID}" method="post">
                                            <div class="card-body">
                                                <div class="d-flex align-items-start align-items-sm-center gap-4">
                                                    <img
                                                        src="data:image/jpeg/png/jpg;base64,${manufacturer.encodedManufacturerImage}"
                                                        alt="user-avatar"
                                        ...
                                        <hr class="my-0" />
                                        <form action="editmanufacturer?manufacturer=${manufacturer.manufacturerID}" method="POST" >
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="mb-3 col-md-6">
                                                        ...
                                                        <input class="form-control" type="text" name="address" id="address"  placeholder="Manufacturer Address" value="${manufacturer.manufacturerAddress}" />
                                                    </div>
                                                    <div class="mb-3 col-md-6">

                                                        <label for="email" class="form-label">Manufacturer E-mail</label>
                                                        <input
                                                            class="form-control"
                                                            type="text"
                                                            id="email"
                                                            ...
                                                            placeholder="Manufacturer E-mail"
                                                            />
                                                    </div>

                                                    <div class="mb-3 col-md-6">
                                                        <label class="form-label" for="phonenumber">Manufacturer Phone Number</label>
                                                    ...
                                                    <div class="mb-3 col-md-6">
                                                        ...
                                                        <input
                                                            ...
                                                            id="createdDate"
                                                            name="createdDate"
                                                            value="${manufacturer.createdDate}"

                                                            />
                                                    </div>
                                                    <c:forEach items="${requestScope.employees}" var="e" >
                                                        <c:if test="${manufacturer.createdBy eq e.id}">
                                                            <div class="mb-3 col-md-6">

                                                                <label for="createdBy" class="form-label">Created By</label>
                                                                <input class="form-control" type="text" name="createdBy" id="createdBy"   value="${e.firstname} ${e.lastname}" />
                                                            </div>
                                                        </c:if>
                                                    ...
                                                    <div class="mb-3 col-md-6">
                                                        ...
                                                        <label for="modifiedDate" class="form-label">Last Modified Date</label>
                                                        <input

                                                            class="form-control"
                                                            id="modifiedDate"
                                                            name="modifiedDate"
                                                            value="${manufacturer.modifiedDate}"

                                                            />
                                                    </div>
                                                    <c:forEach items="${requestScope.employees}" var="e" >
                                                        <c:if test="${manufacturer.modifiedBy eq e.id}">
                                                            <div class="mb-3 col-md-6">

                                                                <label for="modifiedBy" class="form-label">Last Modified By</label>
                                                                <input class="form-control" type="text" name="modifiedBy" id="modifiedBy"   value="${e.firstname} ${e.lastname}" />
                                                            </div>
                                                        </c:if>
                                                    ...
                                                    <div class="mb-3 col-md-6">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <div class="col-md-12 col-lg-12">
                                                                <input class="form-control" type="text" name="description" value="${manufacturer.description}"  id="editor"/>
                                                            </div>
                                                        </div>
                                                    </div>
