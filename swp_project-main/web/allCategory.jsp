                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Stock /</span> All Category</h4>
                                ...
                                <div class="table-responsive text-nowrap">
                                    <table class="table table-striped">
                                        ...
                                        <tbody id="table-data" class="table-border-bottom-0">
                                            <c:forEach items="${requestScope.categories}" var="c" varStatus="index">
                                                <tr>
                                                    <td>${index.index+1}</td>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <a href="#" data-bs-toggle="modal" data-bs-target="#basicModal${c.categoryID}"
                                                               ><i class="bx bx-edit-alt me-1 "></i></a>
                                                                <c:forEach items="${count}" var="ca">
                                                                    <c:if test="${ca eq c.categoryID}">  
                                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#basicModals${c.categoryID}"
                                                                       ><i class="bx bx-trash me-1"></i></a
                                                                    >
                                                                </c:if>  

                                                            </c:forEach>
                                                            <c:forEach items="${count1}" var="ca1">
                                                                <c:if test="${ca1 eq c.categoryID}">  
                                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#basicModals"
                                                                       ><i class="bx bx-trash me-1"></i></a
                                                                    >
                                                                </c:if>  
                                                            ...
                                                            <a href="<%=request.getContextPath()%>/stock?categoryID=${c.categoryID}">
                                                    ...
                                                    <!-- Modal 1 -->
                                            <form action="editcategory?categoryid=${c.categoryID}" >
                                                <input type="hidden" name="id" value="${c.categoryID}"/>
                                                <div class="modal fade" id="basicModal${c.categoryID}" tabindex="-1" aria-hidden="true">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <div class="col mb-3">
                                                                        ...
                                                                        <input type="text" name="name" id="nameBasic${c.categoryID}" class="form-control"  value="${c.categoryName}"/>
                                                                    </div>
                                                                </div>
                                                                <div class="row g-2">
                                                                    <div class="col mb-0">
                                                                        <label for="emailBasic" class="form-label">Description</label>
                                                                        <input type="text" name="description" id="emailBasic${c.categoryID}" class="form-control"  value="${c.description}"/>
                                                                    </div>
                                            ...
                                            <form action="deletecategory?categoryid=${c.categoryID}" >
                                                <input type="hidden" name="categoryid" value="${c.categoryID}"/>
                                                <div class="modal fade" id="basicModals${c.categoryID}" tabindex="-1" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="row g-2">
                                                                    <div class="col mb-0">
                                                                        <label for="emailBasic" class="form-label">Are you sure to delete ${c.categoryName}?</label>
                            ...
                            <div class="modal fade" id="basicModals" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row g-2">
                                                <div class="col mb-0">
                                                    <label for="emailBasic" class="form-label">Cannot delete this category because there are some products belong to!</label>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="pagination">
                                                <c:forEach begin="${1}" end="${requestScope.num}" var="i">
                                                    <a class="${i==page?"active":""}" href="stock?page=${i}"><button class="customBtn btn btn-primary">${i}</button>&nbsp;</a> 
                                                </c:forEach>
                                            </div>
                                        </div>
                                    </div>
                                    <span style=""><a href="<%=request.getContextPath()%>/stockexport?id=3" ><button class="customBtn col-2 btn btn-primary stick"><i class="fa fa-file-excel-o"></i> Export to Excel</button></a></span>
                                </div>   
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col mb-3">
                                                        <label for="nameBasic" class="form-label">Category Name</label>
                                                        <input type="text" name="name" id="nameBasic" class="form-control" placeholder="Enter Category Name" />
                                                    </div>
                                                </div>
                                                <div class="row g-2">
                                                    <div class="col mb-0">
                                                        <label for="emailBasic" class="form-label">Description</label>
                                                        <input type="text" name="description" id="emailBasic" class="form-control" placeholder="Enter description" />
                                                    </div>
