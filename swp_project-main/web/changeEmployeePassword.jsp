                ...
                <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                    <div class="app-brand demo">
                        <a href="index.html" class="app-brand-link">
                            <span class="app-brand-text demo menu-text fw-bolder ms-2">Betrolimex</span>
                        </a>
                        ...
                        <c:if test="${account.role eq 'Admin'}">
                            <li class="menu-item">
                                ...
                                <ul class="menu-sub">
                                    ...
                                    <li class="menu-item">
                                        <a href="allNewsEmployee" class="menu-link">
                                            <div data-i18n="Horizontal Form">All News</div>
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <ul class="menu-sub">
                                <li class="menu-item">
                                    <a href="checkwarranty" class="menu-link">
                                        <div data-i18n="Warranty">Approve warranty</div>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="changewarranty" class="menu-link">
