                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Employee Statistic</h4>
                            ...
                            <div class="card">
                                ...
                                <form action="employeestatistic" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            Employee: <select class="form-control" name="eid">
                                                <option value="-1">All Employees</option>

                                                <c:forEach items="${employeeses}" var="ems">
                                                    <option value="${ems.id}" <c:if test="${ems.id eq eid}"> selected="selected"</c:if>>${ems.firstname} ${ems.lastname}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <a href="employeedetailstatistic?employeeid=${e.id}"
